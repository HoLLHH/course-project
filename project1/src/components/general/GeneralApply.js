        ...
        <Form style={{width:"100%"}}>
            ...
            <Form.Group className='mt-3'>
              <Row>
                ...
                <Col lg={9}>
                  <Form.Control type='text' disabled="disabled" {...register("tel",{required:true})}/>{errors.tel && <span style={{color:"red"}}>not telephone number</span>}
                </Col>
              </Row>
            </Form.Group>
        </Form>
